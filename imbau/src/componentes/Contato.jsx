...
import { Instagram, Selo, Whatsapp } from './Interface';
  ...
  return (
    <button
      ...
      className={`rounded-full border px-4 py-2 text-sm transition-all duration-500 ease-[cubic-bezier(.16,1,.3,1)] ${
        ativo
          ? 'border-ouro-500 bg-ouro-500 text-noite-900'
          : 'border-white/15 text-osso-100/70 hover:border-white/40 hover:text-osso-100'
      }`}
      {...resto}
    >
      {children}
...
const campo =
  'w-full rounded-2xl border border-white/12 bg-noite-900/60 px-4 py-3 text-sm text-osso-100 placeholder:text-osso-100/35 transition-colors duration-300 hover:border-white/25 focus:border-ouro-500/70 focus:outline-none';
...
export function Contato() {
  ...
  return (
    <section id="contato" className="relative bg-noite-900 pb-24 pt-4 sm:pb-32">
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            <Revelar>
              <Selo>{contato.selo}</Selo>
            </Revelar>
            <Revelar atraso={100}>
              <h2 className="titulo mt-7 text-[clamp(2.1rem,4.6vw,3.4rem)] leading-[1.02] text-osso-100">
                {contato.titulo}
              </h2>
            </Revelar>
            <Revelar atraso={180}>
            ...
            <Revelar atraso={260} className="mt-10 flex flex-col gap-4">
              <a
                ...
                className="group flex items-center gap-4 text-osso-100"
              >
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full border border-white/15 text-ouro-500 transition-colors duration-500 group-hover:border-ouro-500/60">
                ...
                <span>
                  ...
                  <span className="block text-[0.78rem] text-osso-100/45">{contato.horario}</span>
                </span>
              </a>
              ...
              >
                ...
                <span>
                  ...
                  <span className="block text-[0.78rem] text-osso-100/45">
                    Imóveis novos toda semana
                  </span>
                </span>
              </a>
              <p className="mt-4 max-w-sm border-t border-white/8 pt-6 text-[0.85rem] leading-relaxed text-osso-100/50">
                {contato.regiao}
              </p>
            </Revelar>
          </div>
          ...
          <Revelar
            atraso={140}
            distancia={30}
            className="rounded-[2rem] border border-ouro-500/25 bg-noite-800/60 p-1.5"
          >
            <div className="rounded-[calc(2rem-0.375rem)] border border-white/8 bg-noite-800 p-6 sm:p-8">
              <fieldset>
                <legend className="sobretexto text-osso-100/40">{contato.rotulos.objetivo}</legend>
              ...
              <fieldset className="mt-8">
                <legend className="sobretexto text-osso-100/40">{contato.rotulos.tipo}</legend>
                <div className="mt-4 flex flex-wrap gap-2">
                  {contato.tipos.map((t) => (
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <label className="block">
                  <span className="sobretexto block text-osso-100/40">
              ...
              <div className="mt-8 rounded-2xl border border-white/8 bg-noite-900/70 p-5">
                <p className="sobretexto text-osso-100/35">{contato.rotulos.previa}</p>
                <p className="mt-3 text-[0.92rem] leading-relaxed text-osso-100/80">{texto}</p>
              </div>
